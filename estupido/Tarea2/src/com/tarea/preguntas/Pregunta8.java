...
public class Pregunta8 extends Activity {
	
	EditText txtValor; 
	ListView lista;
	String nombre;
	int correcto, incorrecto;
	String[] valores = new String[] {"1) Un algoritmo de planifiacion espcial.", 
			"2) Instrucciones de un programa destinadas a ser ejecutadas por el microprocesador.",
			"3) Un conjunto de instrucciones que no van al procesador."};
	...
	**********************************************************/
	public void continuar(View v) {
		...
		Intent P1 = new Intent(this, Pregunta9.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pregunta8, menu);
		return true;
	}
