...
public class Pregunta6 extends Activity {
	...
	String[] valores = new String[] {"1) La interfaz es intuitiva.", 
			"2) Es menos vulnerable a virus y malware.",
	...
	**********************************************************/
	public void continuar(View v) {
		...
		Intent P1 = new Intent(this, Pregunta7.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pregunta6, menu);
		return true;
	}
