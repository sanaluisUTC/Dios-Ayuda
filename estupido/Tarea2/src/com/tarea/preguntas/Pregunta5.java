...
public class Pregunta5 extends Activity {
	...
	String[] valores = new String[] { "1) Windows XP", "2) Windows 10","3) Windows Vista" };
	...
	**********************************************************/
	public void continuar(View v) {
		...
		Intent P1 = new Intent(this, Pregunta6.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pregunta5, menu);
		return true;
	}
