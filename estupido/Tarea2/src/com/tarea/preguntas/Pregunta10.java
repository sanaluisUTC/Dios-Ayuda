...
public class Pregunta10 extends Activity {
	
	EditText txtValor; 
	ListView lista;
	String nombre;
	int correcto, incorrecto;
	String[] valores = new String[] {"1) List.", "2) View Process.","3) Tasklist."};
	...
	********************************************/
	public void continuar(View v) {
		...
		Intent P1 = new Intent(this, Resultado.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pregunta10, menu);
		return true;
	}
