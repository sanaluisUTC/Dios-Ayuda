...
public class Pregunta9 extends Activity {
	
	EditText txtValor; 
	ListView lista;
	String nombre;
	int correcto, incorrecto;
	String[] valores = new String[] {"1) Memoria Flash.", 
			"2) Memoria Intermedia de Procesador.",
			"3) Memoria de Solo lectura."};
	...
	********************************************/
	public void continuar(View v) {
		...
		Intent P1 = new Intent(this, Pregunta10.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pregunta9, menu);
		return true;
	}
