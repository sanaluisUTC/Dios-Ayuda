...
public class Pregunta3 extends Activity {
	...
	String[] valores = new String[] { "1) Programas", "2) Ficheros","3) Accesorios" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*************************************
		 * RECIBIENDO DATOS PARA PASARLOS
		*************************************/
	...
	public void continuar(View v) {
		...
		Intent P1 = new Intent(this, Pregunta4.class);	
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pregunta3, menu);
		return true;
	}
